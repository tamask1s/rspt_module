...
/// @param peak_detection_mode RSPT_MODE_DEFAULT is used for CTS/CSE validation; RSPT_MODE_HIGH_SENSITIVITY and RSPT_MODE_HIGH_PPV are optional detector modes.
...
/// Analyze ECG beat morphology and interval metrics.
///
...
/// @param out_summary Output aggregate metrics. RR/heart-rate fields are derived from the effective R-peak list; morphology fields are aggregated over out_beat_results.
