...
double n[] = {0.06722876941, 0.00000000000, -0.13445753881, 0.00000000000, 0.06722876941}; /// BP 0.4-200
double d[] = {1.00000000000, -3.14332095199, 3.70064088865, -1.97083923944, 0.41351972908};

double n[] = {0.02008336556, 0.04016673113, 0.02008336556}; /// LP 100Hz
double d[] = {1.00000000000, -1.56101807580, 0.64135153806};

double n[] = {0.99977788053, -1.99955576105, 0.99977788053}; /// HP 0.1Hz
double d[] = {1.00000000000, -1.99955571171, 0.99955581039};

double n[] = {0.99911181808, -1.99822363616, 0.99911181808}; /// HP 0.4Hz
double d[] = {1.00000000000, -1.99822284729, 0.99822442503};

double n[] = {0.99778102410, -1.99556204821, 0.99778102410}; /// HP 1Hz
double d[] = {1.00000000000, -1.99555712435, 0.99556697207};

double n[] = {0.80059240346, -1.60118480693, 0.80059240346}; /// HP 100Hz
double d[] = {1.00000000000, -1.56101807580, 0.64135153806};
